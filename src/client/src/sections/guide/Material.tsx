...
import {MaterialTableRow, PatchMaterialTableOptions} from "@/apiService/apiGuide/types";
...
const Material = (
    ...
    const [modals, setModals] = useState<OpenModalsType<
        'modal-manage-material' | 'modal-remove-material' | 'modal-multi-remove-material'
